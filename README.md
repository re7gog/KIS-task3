...
Требования: 
1. Реализовать выполнение команды побитовый циклический сдвиг вправо. 
...
Требования: 
1. Написать, скомпилировать и исполнить программу по тестовой задаче: выполнить поэлементно команду побитовый циклический сдвиг вправо над двумя векторами длины 8. Результат записать во второй вектор. 
